...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void checkProvider(String provider) {
        Toast.makeText(this, provider + "에의한 위치서비스가 꺼져있습니다. 켜주세요...", Toast.LENGTH_SHORT).show();
    ...
    public void updateMap(Location location) {
        ...
        if (prev_LOC == null) {
            ...
            path.setCoords(Arrays.asList(new LatLng(prev_LOC.latitude, prev_LOC.longitude),new LatLng(curr_LOC.latitude,curr_LOC.longitude)));
            path.setMap(mMap);
